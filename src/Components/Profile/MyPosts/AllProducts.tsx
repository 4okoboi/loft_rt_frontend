					...
					<div className={classes.filtersWithImgWrapper}>
						<div className={classes.filtersWithImg}>
							<div
								...
								onClick={() => setSelectedCategory('Торговое оборудование')}
							>
							...
							<div
								...
								onClick={() => setSelectedCategory('Офисная мебель')}
							>
								<div className={classes.labelWrapper}>
							...
							<div
								...
								onClick={() => setSelectedCategory('Кафе, бары, рестораны')}
							>
								<div className={classes.labelWrapper}>
									<div className={classes.filterLabel}>
							...
							<div
								...
								onClick={() => setSelectedCategory('Мебель для дома')}
							>
								<div className={classes.labelWrapper}>
							...
							<div
								...
								onClick={() => setSelectedCategory('Кухни, шкафы купе')}
							>
								<div className={classes.labelWrapper}>
									<div className={classes.filterLabel}>
							...
							<div
								...
								onClick={() => setSelectedCategory('Для гостиниц')}
							>
								<div className={classes.labelWrapper}>
